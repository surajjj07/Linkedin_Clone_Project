...
/*
This middleware allows user to send friend req to another user !
*/
export const sendConnection = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ newRequest, message: "Request has been sent !" });
  } catch (error) {
    return res.status(500).json({ message: `Can not send req ${error}` });
  }
};

/*
This middleware allows user to accept friend req.
*/
export const acceptConnection = async (req, res) => {
  try {
    ...
    let notification = await Notification.create({  //create notification
...
/*
This middleware allows user to reject the req send by another user !
*/
...
/*
This middleware find all friend req And set the status .
*/
...
/*
This middleware allows the user to remove all recieved req.If user accepts and 
reject the req after that it shoud be removed.
*/
